...
- Every resolved source path must remain beneath the configured OneDrive root. Filenames are basename-normalized, control/reserved characters are replaced, and stored originals receive collision-safe prefixes.
